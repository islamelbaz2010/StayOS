...
export type RootStackParamList = {
  ...
  Booking: { unitId: string; title: string; price: number; currency: string; maxGuests: number; minNights: number; maxNights: number; checkIn?: string; checkOut?: string; adults?: number; children?: number; infants?: number };
