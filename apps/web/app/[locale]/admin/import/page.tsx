          ...
          <div className="space-y-6">
            ...
            {phase === "idle" && (
              <div
                ...
                className="rounded-card border-2 border-dashed border-neutral-300 bg-neutral-50 p-12 text-center transition-colors hover:border-accent-400 hover:bg-accent-50"
              >
                <input
                  ref={fileInputRef}
                  type="file"
                ...
                <button
                  ...
                  className="btn-primary mx-auto block text-sm disabled:opacity-50"
                >
                ...
                <a
                  ...
                  download
                  className="mt-2 inline-block text-sm font-medium text-accent-600 hover:text-accent-700 hover:underline"
                >
                  {t("downloadTemplate")}
                </a>
              </div>
            ...
            {phase === "importing" && (
              <div className="flex min-h-[300px] items-center justify-center">
                <div className="text-center">
                  <div className="mx-auto h-12 w-12 animate-spin rounded-full border-4 border-neutral-200 border-t-accent-500" />
            ...
            {phase === "complete" && summary && (
              <div className="space-y-4">
                <div className="rounded-card bg-success-50 p-6 text-center">
                      ...
                      <tbody className="divide-y divide-neutral-100 bg-surface-card">
                        {summary.results.map((r) => (
                          <tr key={r.row_number}>
                            ...
                            <td className="px-4 py-3 text-sm text-danger-600">
                              {r.error || "—"}
                            </td>
                          </tr>
                        ))}
