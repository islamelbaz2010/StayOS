...
| [`docs/release/FOUNDER_WEB_ACCEPTANCE_REGISTER.md`](release/FOUNDER_WEB_ACCEPTANCE_REGISTER.md) | Founder web acceptance review surfaces + blank observation register | Ph0→Ph1 | Active |
